 ...
 *  Compilation:  javac implementation1.StdIn.java
 *  Execution:    java implementation1.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The <tt>implementation1.StdIn</tt> class provides static methods for reading strings
 ...
 *  <pre>
 *  while (!implementation1.StdIn.hasNextChar()) {
 *      char c = implementation1.StdIn.readChar();
 *      implementation1.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (!implementation1.StdIn.hasNextLine()) {
 *      String line = implementation1.StdIn.readLine();
 *      implementation1.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = implementation1.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code implementation1.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  Some of the main differences are summarized below:
 *  <ul>
 *  <li> {@code implementation1.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code implementation1.StdIn} uses whitespace as the delimiter between tokens.
 *  <li> {@code implementation1.StdIn} coerces the character-set encoding to UTF-8,
 *       which is a standard character encoding for Unicode.
 *  <li> {@code implementation1.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code implementation1.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code implementation1.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code implementation1.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, <tt>implementation1.StdIn</tt>
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to implementation1.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to implementation1.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to implementation1.StdIn,
    ...
    //// end: section (2 of 2) of code duplicated from In to implementation1.StdIn


    // do this once when implementation1.StdIn is initialized
    static {
        resync();
    }

    /**
     * If implementation1.StdIn changes, use this to reinitialize the scanner.
     */
